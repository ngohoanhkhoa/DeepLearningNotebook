...
# experiments_deep_models documentation build
...
from experiments_deep_models import __version__ as release

# -- Project information -----------------------------------------------------

project = "experiments_deep_models"
author = "Kedro"
...
htmlhelp_basename = "experiments_deep_modelsdoc"
...
latex_documents = [
    (
        master_doc,
        "experiments_deep_models.tex",
        "experiments_deep_models Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "experiments_deep_models",
        "Project experiments_deep_models codebase.",
        "Data-Science",
    )
]
